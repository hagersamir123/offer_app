        ...
        child: Column(
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
              RaisedButton(child: Icon(Icons.add),onPressed: _incrementCounter,color: Colors.blue,),
              ...
              RaisedButton(child: Icon(Icons.minimize),onPressed: _decrementCounter,color: Colors.blue),
            ],
            ),
          ),
